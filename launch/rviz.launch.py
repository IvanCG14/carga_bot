...
def generate_launch_description():
    ...
    # Process XACRO
    xacro_path = os.path.join(get_package_share_directory('carga_bot'), 'urdf', 'carga_bot.xacro')
    ...
    rviz = Node(
        ...
        name='rviz2',
        output='screen',
        arguments=['-d', os.path.join(get_package_share_directory('carga_bot'), 'rviz', 'entire_setup.rviz')]
    )
