...
def generate_launch_description():
    # Get carga_bot package's share directory path
    ...
    robot_namespace = LaunchConfiguration("robot_namespace", default='carga_bot')
    
    # Path to the Xacro file
    xacro_path = join(carga_bot_path, 'urdf', 'carga_bot.xacro')
    ...
    spawn_entity = Node(
        ...
        arguments=[
            ...
            '-entity', PythonExpression(['"', robot_namespace, '_robot"']), #default enitity name _carga_bot
            '-z', "0.28",
            '-x', position_x,
            '-y', position_y,
            '-Y', orientation_yaw
