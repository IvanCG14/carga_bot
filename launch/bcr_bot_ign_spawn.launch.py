...
def generate_launch_description():
    ...
    #     join(carga_bot_path, "urdf", "carga_bot.xacro"),
    #     {"sim_gz": "true",
    ...
    robot_state_publisher = Node(
        ...
        parameters=[
                    ...
                    ['xacro ', join(carga_bot_path, 'urdf/carga_bot.xacro'),
        ...
        remappings=[
            ('/joint_states', 'carga_bot/joint_states'),
        ]
    )
    ...
    gz_ros2_bridge = Node(
        ...
        arguments=[
            ...
            "/world/default/model/carga_bot/joint_state@sensor_msgs/msg/JointState[ignition.msgs.Model"
        ],
        remappings=[
            ('/world/default/model/carga_bot/joint_state', 'carga_bot/joint_states'),
            ('/odom', 'carga_bot/odom'),
            ('/scan', 'carga_bot/scan'),
            ('/kinect_camera', 'carga_bot/kinect_camera'),
            ('/stereo_camera/left/image_raw', 'carga_bot/stereo_camera/left/image_raw'),
            ('/stereo_camera/right/image_raw', 'carga_bot/stereo_camera/right/image_raw'),
            ('/imu', 'carga_bot/imu'),
            ('/cmd_vel', 'carga_bot/cmd_vel'),
            ('kinect_camera/camera_info', 'carga_bot/kinect_camera/camera_info'),
            ('stereo_camera/left/camera_info', 'carga_bot/stereo_camera/left/camera_info'),
            ('stereo_camera/right/camera_info', 'carga_bot/stereo_camera/right/camera_info'),
            ('/kinect_camera/points', 'carga_bot/kinect_camera/points'),
        ]
    )
    ...
    transform_publisher = Node(
        ...
        arguments = ["--x", "0.0",
                    ...
                    "--child-frame-id", "carga_bot/base_footprint/kinect_camera"]
    )
